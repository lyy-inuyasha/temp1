...
def parse_args():
    ...
    parser.add_argument('--log_dir', default='logs/vit_region')
...
def build_model(args):
    return ViT(patch_size=(2, 3, 1), in_channels=2, img_size=(26, 33, 23),
          pos_embed='conv', classification=False, num_classes=1, num_layers=4)
