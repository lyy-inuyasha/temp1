...
def parse_args():
    ...
    parser.add_argument('--ckpt', default='/data/ssd_2/liuyy/BrainAgeLujm/Brain_Baseline/brain-baseline/logs/resnet-20240306114401/20240306202736-e61-7.1611.ckpt', type=str)
