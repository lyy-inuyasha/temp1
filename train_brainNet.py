...
from models.BraNet import BraNet
...
def parse_args():
    ...
    parser.add_argument('--bs', default=1200, type=int)
    parser.add_argument('--lr', default=0.0001, type=float)
    parser.add_argument('--wd', default=0.05, type=float)
    # parser.add_argument('--model', default='resnet')
    parser.add_argument('--epochs', default=50, type=int)
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--log_dir', default='logs/branet_region')
...
def build_model(args):
    return BraNet(in_channel=2, n_classes=1)
